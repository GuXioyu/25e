...
typedef enum                                                                    // 枚举串口引脚 此枚举定义不允许用户修改
{
    ...
    // UART 1 TX 引脚
    UART1_TX_A3     = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF10 << UART_PIN_AF_OFFSET) | (A3)),
    UART1_TX_A5     = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF11 << UART_PIN_AF_OFFSET) | (A5)),
    ...
    UART1_TX_B21    = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF6  << UART_PIN_AF_OFFSET) | (B21)),
...
//    UART2_TX_B17    = ((UART_2 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B17)),
    ...
    UART3_TX_A25    = ((UART_3 << UART_INDEX_OFFSET) | (GPIO_AF9  << UART_PIN_AF_OFFSET) | (A25)),
    ...
    // UART 4 TX 引脚
    UART4_TX_B10    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF6  << UART_PIN_AF_OFFSET) | (B10)),
    UART4_TX_B17    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF8  << UART_PIN_AF_OFFSET) | (B17)),
    UART4_TX_B21    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B21)),
    
    // UART 5 TX 引脚
    UART5_TX_A1     = ((UART_5 << UART_INDEX_OFFSET) | (GPIO_AF12 << UART_PIN_AF_OFFSET) | (A1)),

    // UART 6 TX 引脚
    UART6_TX_B22    = ((UART_6 << UART_INDEX_OFFSET) | (GPIO_AF9  << UART_PIN_AF_OFFSET) | (B22)),

    // UART 7 TX 引脚
    UART7_TX_A13    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF10 << UART_PIN_AF_OFFSET) | (A13)),
    UART7_TX_A21    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (A21)),
    UART7_TX_A23    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (A23)),
    UART7_TX_B2     = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF8  << UART_PIN_AF_OFFSET) | (B2)),
    UART7_TX_B15    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B15)),
    UART7_TX_B17    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B17)),
}uart_tx_pin_enum;
...
typedef enum                                                                // 枚举串口引脚 此枚举定义不允许用户修改
{
    ...
    // UART 1 RX 引脚
    UART1_RX_A4     = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF10 << UART_PIN_AF_OFFSET) | (A4)),
    UART1_RX_A6     = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF11 << UART_PIN_AF_OFFSET) | (A6)),
    ...
    UART1_RX_B22    = ((UART_1 << UART_INDEX_OFFSET) | (GPIO_AF6  << UART_PIN_AF_OFFSET) | (B22)),
...
//    UART2_RX_B18    = ((UART_2 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B18)),
    ...
    UART3_RX_A26    = ((UART_3 << UART_INDEX_OFFSET) | (GPIO_AF9  << UART_PIN_AF_OFFSET) | (A26)),
    UART3_RX_A27    = ((UART_3 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (A27)),
    ...
    // UART 4 RX 引脚
    UART4_RX_B11    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF6  << UART_PIN_AF_OFFSET) | (B11)),
    UART4_RX_B18    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF8  << UART_PIN_AF_OFFSET) | (B18)),
    UART4_RX_B22    = ((UART_4 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B22)),

    // UART 5 RX 引脚
    UART5_RX_A0     = ((UART_5 << UART_INDEX_OFFSET) | (GPIO_AF12 << UART_PIN_AF_OFFSET) | (A0)),

    // UART 6 RX 引脚
    UART6_RX_B21    = ((UART_6 << UART_INDEX_OFFSET) | (GPIO_AF9  << UART_PIN_AF_OFFSET) | (B21)),

    // UART 7 RX 引脚
    UART7_RX_A14    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF10 << UART_PIN_AF_OFFSET) | (A14)),
    UART7_RX_A22    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (A22)),
    UART7_RX_A24    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (A24)),
    UART7_RX_B3     = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF8  << UART_PIN_AF_OFFSET) | (B3)),
    UART7_RX_B16    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B16)),
    UART7_RX_B18    = ((UART_7 << UART_INDEX_OFFSET) | (GPIO_AF2  << UART_PIN_AF_OFFSET) | (B18)),
}uart_rx_pin_enum;
